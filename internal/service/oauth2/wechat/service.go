...
type Service interface {
	...
	Verify(ctx context.Context, code string, state string) (domain.WechatInfo, error)
}
...
func (s *service) Verify(ctx context.Context, code string, state string) (domain.WechatInfo, error) {
