...
// Source: ./internal/repository/code_repo.go
//
// Generated by this command:
//
//	mockgen -source=./internal/repository/code_repo.go -destination=./internal/repository/mocks/code_repo.mock.go -package=repomocks
//
...
func (m *MockCodeRepository) Verify(ctx context.Context, biz, phone, code string) error {
	m.ctrl.T.Helper()
